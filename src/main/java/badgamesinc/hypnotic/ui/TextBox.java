...
//            fill(matrices, this.x, this.y, this.x + this.width, this.y + this.height, -16777216);
         ...
         if (!string.isEmpty()) {
            ...
            this.textRenderer.drawWithShadow(matrices, /*((OrderedText)this.renderTextProvider.apply(string2, this.firstCharacterIndex)).toString()*/ string2, (float)m, (float)n, j);
         }
...
//            this.textRenderer.drawWithShadow(matrices, string.substring(k), (float)o, (float)n, j);
//         }
         ...
         if (bl2) {
            if (bl3) {
               ...
               this.textRenderer.drawWithShadow(matrices, "_", (float)p + textRenderer.getStringWidth(this.getText()), (float)n, j);
            }
         }

         if (l != k) {
            int q = (int) (m + this.textRenderer.getStringWidth(string.substring(0, l)));
            var10002 = n - 1;
            var10003 = q - 1;
            var10004 = n + 1;
            Objects.requireNonNull(this.textRenderer);
   ...
   public int getCharacterX(int index) {
      return (int) (index > this.text.length() ? this.x : this.x + this.textRenderer.getStringWidth(this.text.substring(0, index)));
   }
