...
import dev.hypnotic.hypnotic_client.command.argtypes.CompoundNbtTagArgumentType;
        ...
        builder.then(literal("add").then(argument("nbt_data", CompoundNbtTagArgumentType.nbtTag()).executes(s -> {
            ...
            if (validBasic(stack)) {
                ...
                if (tag != null && source != null) {
                    ...
                    error("Some of the NBT data could not be found, try using: " + CommandManager.get().getPrefix() + "nbt set {nbt}");
                }
            }
