...
import dev.hypnotic.hypnotic_client.command.argtypes.BlockStateArgumentType;
...
public class Search extends Command {
	...
	dev.hypnotic.hypnotic_client.module.render.Search search = ModuleManager.INSTANCE.getModule(dev.hypnotic.hypnotic_client.module.render.Search.class);
	public Search() {
