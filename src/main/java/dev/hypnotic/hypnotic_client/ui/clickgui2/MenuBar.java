package dev.hypnotic.hypnotic_client.ui.clickgui2;
			...
			if (hoveredTab(tab, mouseX, mouseY) && button == 0) {
				switch(tab) {
					case CLICKGUI:
						...
						mc.setScreen(ModuleManager.INSTANCE.getModule(ClickGUIModule.class).mode.is("New") ? dev.hypnotic.hypnotic_client.ui.clickgui.ClickGUI.INSTANCE : ClickGUI.INSTANCE);
						break;
					case HUDEDITOR:
