...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader(String fragmentShaderLocation) throws IOException {
        ...
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/hypnotic/shaders/passthrough.vsh"), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/hypnotic/shaders/" + fragmentShaderLocation), GL_FRAGMENT_SHADER));
    ...
    public GLSLSandboxShader(String vertexShaderLocation, String fragmentShaderLocation) throws IOException {
        int program = glCreateProgram();

        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/hypnotic/shaders/" + vertexShaderLocation), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/hypnotic/shaders/" + fragmentShaderLocation), GL_FRAGMENT_SHADER));
